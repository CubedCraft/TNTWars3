package com.jeroenvdg.tntwars.services.cosmetics
...
class CosmeticsService(private val hikari: HikariDataSource, private val serverName: String) : IBoosterService {
