...
class TNTWars : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        lifecycleManager.registerEventHandler(LifecycleEvents.COMMANDS) { commands ->
            val rg = commands.registrar()
            ShopCommand.create(rg)
            SettingsCommand.create(rg)
            ProfileCommand.create(rg)
            BoosterCommand.create(rg)
            TeamCommand.create(rg)
            TeamChatCommand.create(rg)
            MapCommand.create(rg)
            GameCommand(mapManager).create(rg)
            MapManagerCommand(mapManager).create(rg)
        }
