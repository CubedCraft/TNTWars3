...
class PlayerDeathHelper {
    ...
    fun getDeathContext(behaviour: PlayerDamageBehaviour): PlayerDeathContext {
        ...
        val myName = TextHelper.deserialize("&${user.team.primaryColor}${player.name}")
        val enemyName: TextComponent = if (lastDamagedUser != null) TextHelper.deserialize("&${lastDamagedUser.team.primaryColor}${lastDamagedPlayer!!.name}") else Component.text("")

        when {
            lastDamagedIsVoid && lastDamagedIsByEnemy && lastDamageByEnemyWasResent -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" got knocked into the void by ").color(NamedTextColor.GRAY))
                    .append(enemyName)
                    .build()
            ...
            lastDamagedIsVoid && lastDamagedIsByEnemy -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" got knocked into the void whilst trying to escape ").color(NamedTextColor.GRAY))
                    .append(enemyName)
                    .append(Component.text("'s tnt").color(NamedTextColor.GRAY))
                    .build()
                return PlayerDeathContext(DeathReason.Void, user, msg, lastDamagedUser)
            }
            lastDamagedIsVoid && lastDamageIsSelf -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" knocked their self into the void").color(NamedTextColor.GRAY))
                    .build()
            ...
            lastDamagedIsFall && lastDamagedIsByEnemy && lastDamageByEnemyWasResent -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" hit the ground hard thanks to ").color(NamedTextColor.GRAY))
                    .append(enemyName)
                    .append(Component.text("'s tnt").color(NamedTextColor.GRAY))
                    .build()
            ...
            lastDamagedIsFall && lastDamagedIsByEnemy -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" hit the ground hard whilst trying to escape ").color(NamedTextColor.GRAY))
                    .append(enemyName)
                    .append(Component.text("'s tnt").color(NamedTextColor.GRAY))
                    .build()
                return PlayerDeathContext(DeathReason.Fall, user, msg, lastDamagedUser)
            ...
            lastDamagedIsFall && lastDamageIsSelf -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" hit the ground hard thanks to their own cannon").color(NamedTextColor.GRAY))
                    .build()
            ...
            lastDamagedIsFall -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" fell to their death").color(NamedTextColor.GRAY))
                    .build()
                return PlayerDeathContext(DeathReason.Fall, user, msg, null)
            }
            lastDamagedIsByEnemy && lastDamageByEnemyWasResent -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" got killed by ").color(NamedTextColor.GRAY))
                    .append(enemyName)
                    .build()
            ...
            lastDamagedIsByEnemy -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" died whilst trying to escape ").color(NamedTextColor.GRAY))
                    .append(enemyName)
                    .append(Component.text("'s tnt").color(NamedTextColor.GRAY))
                    .build()
                return PlayerDeathContext(DeathReason.Killed, user, msg, lastDamagedUser)
            ...
            lastDamageIsSelf -> {
                val msg = Component.text()
                    .append(myName)
                    .append(Component.text(" got killed by their own cannon").color(NamedTextColor.GRAY))
                    .build()
